...
Скрипт выводит содержимое json-файла в удобном для чтения виде

# Quickstart


Скрипт требует для своей работы установленный интерпретатор Python версии 3.5, а также файл с необходимыми данными в формате json
